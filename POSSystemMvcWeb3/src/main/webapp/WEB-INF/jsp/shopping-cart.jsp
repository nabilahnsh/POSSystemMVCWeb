...
<table border =5 width=60%>
        <thead>
        	<tr>
    			...
    			<th colspan="7"><font size="5">${sessionScope.sale.getSaleNumber()}</th>
        	</tr>
            <tr>
                <th> item_code </th>
				<th> price </th>
        ...
        <tbody>
    		...
    		<th colspan="7"><font size="4">${sessionScope.sale.grandTotal()}</th>
    		<tr>
    		<th colspan="1"><font size="4">tax</th>
    		<th colspan="7"><font size="4">${sessionScope.sale.totalTaxPayment()}</th>
    		</tr>
    		<tr>
    		<th colspan="1"><font size="4">total payment</th>
    		<th colspan="7">${sessionScope.sale.grandTotal() + sessionScope.sale.totalTaxPayment()}</th>   
			</tr>
